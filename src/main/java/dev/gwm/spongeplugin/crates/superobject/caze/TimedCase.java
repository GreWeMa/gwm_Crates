...
public final class TimedCase extends GiveableCase {
    ...
    public static final String SELECT_QUERY = "SELECT expire FROM timed_cases " +
            "WHERE name = ? " +
            "AND uuid = ?";
    ...
    public static final String INSERT_QUERY = "INSERT INTO timed_cases (name, uuid, expire) " +
            "VALUES (?, ?, ?)";
    ...
    private void setCfg(Player player, boolean withdraw) {
        ConfigurationNode expireNode = GWMCrates.getInstance().getTimedCasesConfig().
